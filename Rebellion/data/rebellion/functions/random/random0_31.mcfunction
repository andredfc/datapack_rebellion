...
execute if predicate rebellion:50percent run scoreboard players set b4 Random 1
...
scoreboard players operation b4 Random *= b4m Random
scoreboard players set 0_31 Random 0
scoreboard players operation 0_31 Random += b0 Random
scoreboard players operation 0_31 Random += b1 Random
scoreboard players operation 0_31 Random += b2 Random
scoreboard players operation 0_31 Random += b3 Random
scoreboard players operation 0_31 Random += b4 Random